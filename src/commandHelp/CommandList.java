...
//		cmdList.add(cmd);
		...
		cmd.setAdditionalDescription(""
				...
				+ "a regex. It is useful for example to highlight features of interest such as CDS. "
				+ "Currently the color is assigned to the text background."
				+ "\n"
				+ "For available colors see :code:`colorTrack -h`. As :code:`colorTrack` "
