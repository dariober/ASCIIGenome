  ...
  public static final List<CommandHelp> commandHelpList()
    ...
    cmd.setAdditionalDescription(
        "\n"
            ...
            + " '^$'\n"
            + "\n"
            + ":code:`-f` Filter samples using an expression in javascript syntax. See below for"
            + " details.\n"
            + "\n"
            + ":code:`-v` Invert selection: apply changes to the tracks not selected by list of"
            + " track_regex\n"
            ...
            + " expression string is evaluated as a javascript script so any valid JS code is"
