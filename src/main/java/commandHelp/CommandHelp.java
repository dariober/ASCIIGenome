...
public class CommandHelp {
  ...
  /**
   * Wrap lines once maxLen is exceeded. Use ~ to separate words that should stay on the same line
   * and to add spaces.
   */
  private List<String> wrapLines(String text, int maxLen) {
    ...
    Iterable<String> words =
        Splitter.on(" ").trimResults(CharMatcher.is(' ')).omitEmptyStrings().split(text);
