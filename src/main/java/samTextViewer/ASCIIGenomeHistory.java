...
public class ASCIIGenomeHistory {
    ...
    final private static String DEFAULT_FILENAME = System.getProperty("user.home") + File.separator + ".asciigenome" + File.separator + "history.yaml";
    final private int MAX_FILES = 200;
    final private int MAX_CMDS = 2000;
    ...
    private void moveOldHistoryFile() {
        ...
        if (oldFile.isFile()) {
            System.err.println("Warning: The history file from older version of ASCIIGenome is going to be moved to " + DEFAULT_FILENAME);
