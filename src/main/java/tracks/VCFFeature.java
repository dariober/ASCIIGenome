...
public class VCFFeature extends IntervalFeature {
  ...
  // private TrackFormat trackFormat = TrackFormat.VCF;
  ...
  public VCFFeature(String chrom, int from, int to)
      throws InvalidGenomicCoordsException {
  ...
  public boolean equals(VCFFeature x) {
    if (x == null) {
      return false;
    }
  ...
  public boolean equalStranded(VCFFeature x) {
    if (x == null) {
      return false;
    }
  ...
  private String getNameForIdeogram() {
    return this.name;
  }
  ...
  public String getName() {
    return this.getNameForIdeogram();
  }
  ...
  public int compareTo(VCFFeature other) {
