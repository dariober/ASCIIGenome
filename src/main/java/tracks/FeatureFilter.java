...
class FeatureFilter {
  ...
  //	final static public String DEFAULT_HIDE_REGEX= "^$"; protected String hideRegex=
  // DEFAULT_HIDE_REGEX;
  //	final static public String DEFAULT_SHOW_REGEX= ".*"; protected String showRegex=
  // DEFAULT_SHOW_REGEX;
  ...
  //	public static final String DEFAULT_VARIANT_CHROM= ""; String variantChrom=
