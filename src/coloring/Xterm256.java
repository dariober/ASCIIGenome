...
public class Xterm256 {
	...
	public Xterm256(){
		...
		xtermNameToNumber.put("white", 231); // NB: white is "15" but 15 shows up as grey-ish. So use 231 (grey100) instead 
...
//	}
	...
	/** Return the colour name contrasting with the input color. See 
	 * Xterm256.colorNameToXterm256() for how input colour can be 
	 * specified.
