...
public class FilterTest {
  ...
  public void exampleFromSamtools() {
    ...
    assertFalse(
        f.filterOut(rec)); // filterOut() returns false because with flag 0 it's not filtered out.
  ...
  public void testFilters() {
    ...
    assertTrue(
        new ReadFailsVendorQualityCheckFilter(false).filterOut(rec)); // Exclude if set: Excluded
