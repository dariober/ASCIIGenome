...
public class TrackSetTest {
  ...
  @Test
  public void canFindNextMatchOnOneTrack()
  ...
  @Test
  public void canFindNextMatchOnOneTrack2()
      throws ClassNotFoundException,
          IOException,
          BamIndexNotFoundException,
          InvalidGenomicCoordsException,
  ...
  @Test
  public void canAddTrackFromCram()
  ...
  @Test
  public void canChangeTrackFormatToBed()
      throws InvalidCommandLineException,
          IOException,
          InvalidGenomicCoordsException,
          ClassNotFoundException,
  ...
  @Test
  public void canFindNextMatchOnTrack()
      throws ClassNotFoundException,
          IOException,
          BamIndexNotFoundException,
          InvalidGenomicCoordsException,
  ...
  @Test
  public void canTrimGenomicCoordinatesForTrack()
      throws InvalidGenomicCoordsException,
          IOException,
          ClassNotFoundException,
          BamIndexNotFoundException,
  ...
  @Test
  public void canPrintFeaturesToFile()
      throws InvalidGenomicCoordsException,
          IOException,
          ClassNotFoundException,
          BamIndexNotFoundException,
  ...
  @Test
  public void canAddTrackFromSourcename()
      throws InvalidGenomicCoordsException,
          IOException,
          BamIndexNotFoundException,
          InvalidRecordException,
  ...
  @Test
  public void canAddTrackVcfWithContigWithoutLength()
      throws InvalidGenomicCoordsException,
          IOException,
          BamIndexNotFoundException,
          InvalidRecordException,
  ...
  public void canInitializeFromListOfFileNames()
      throws InvalidGenomicCoordsException,
          IOException,
          InvalidRecordException,
          ClassNotFoundException,
  ...
  @Test
  public void canAddBookmarkAtPosition()
      throws InvalidGenomicCoordsException,
          IOException,
          ClassNotFoundException,
          InvalidRecordException,
  ...
  @Test
  public void canOrderTracksLast()
      throws InvalidGenomicCoordsException,
          IOException,
          InvalidCommandLineException,
          ClassNotFoundException,
  ...
  @Test
  public void canSetFilterForTrackIntervalFeature()
      throws InvalidCommandLineException,
          IOException,
          InvalidGenomicCoordsException,
          ClassNotFoundException,
  ...
  @Test
  public void canSetAwkForTrackIntervalFeature()
      throws InvalidCommandLineException,
          IOException,
          InvalidGenomicCoordsException,
          ClassNotFoundException,
  ...
  @Test
  public void canSetReadsAsPairs()
      throws InvalidCommandLineException,
          IOException,
          InvalidGenomicCoordsException,
          ClassNotFoundException,
  ...
  @Test
  public void canEditTrackNamesForRegex()
      throws InvalidCommandLineException,
          IOException,
          InvalidGenomicCoordsException,
          SQLException,
  ...
  @Test
  public void canAddHeaderDefault()
      throws InvalidCommandLineException,
          IOException,
          InvalidGenomicCoordsException,
          SQLException,
  ...
  public void canAddHeader()
    ...
    ts.addHeader(
        Utils.tokenize("addHeader -a L Header #1 #2", " "), 80); // Add header to track #1 and #2
    assertTrue(ts.getTrack(t1).concatTitleAndTrack().startsWith("Header\n"));
    ...
    ts.addHeader(
        Utils.tokenize("addHeader -a left ''", " "), 80); // Add blank line between all tracks
    assertTrue(ts.getTrack(t1).concatTitleAndTrack().startsWith("\n"));
    assertTrue(ts.getTrack(t2).concatTitleAndTrack().startsWith("\n"));

    ts.addHeader(
        Utils.tokenize("addHeader -a 0.5 FOOBAR", " "), 10); // Add blank line between all tracks
  ...
  @Test
  public void canEditTrackNamesFixed()
      throws InvalidCommandLineException,
          IOException,
          InvalidGenomicCoordsException,
          SQLException,
  ...
  @Test
  public void canSetFilterFlagForRegex()
      throws InvalidCommandLineException,
          IOException,
          InvalidGenomicCoordsException,
          SQLException,
  ...
  @Test
  public void canSetFeatureDisplayModeForRegex()
      throws InvalidCommandLineException,
          IOException,
          InvalidGenomicCoordsException,
          ClassNotFoundException,
  ...
  @Test
  public void canSetVariantReadsFilter()
      throws InvalidCommandLineException,
          InvalidGenomicCoordsException,
          IOException,
          ClassNotFoundException,
    ...
    ts.setFilterVariantReads(
        Utils.tokenize("filterVariantReads -r '100 +/- 5'", " ")); // With spaces use single quotes
    ...
    ts.setFilterVariantReads(
        Utils.tokenize("filterVariantReads #1", " ")); // Remove filter for this regex track
  ...
  @Test
  public void canHandleGenotypeMatrix()
      throws InvalidGenomicCoordsException,
          IOException,
          ClassNotFoundException,
          InvalidRecordException,
  ...
  @Test
  public void canFilterGenotypeMatrix()
      throws InvalidGenomicCoordsException,
          IOException,
          ClassNotFoundException,
          InvalidRecordException,
