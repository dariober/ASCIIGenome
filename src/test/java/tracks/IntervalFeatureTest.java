...
public class IntervalFeatureTest {
  ...
  //
  //		IntervalFeature plus= new IntervalFeature("chr1 0 10 x . +".replaceAll(" ", "\t"),
  // TrackFormat.BED, null);
  ...
  public void canTestForEqualCoords() throws InvalidGenomicCoordsException {
    IntervalFeature plus =
        new IntervalFeature("chr1 0 10 x . +".replaceAll(" ", "\t"), TrackFormat.BED, null, -1);
    IntervalFeature minus =
        new IntervalFeature("chr1 0 10 y . -".replaceAll(" ", "\t"), TrackFormat.BED, null, -1);
