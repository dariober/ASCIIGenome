...
public class TrackVCFTest {
  ...
  public void canReadBcf()
    ...
    assertTrue(
        tif.getFeatureList()
            .get(0)
            .getRaw()
            .startsWith("chr1\t11994\t.\tT\tC\t.\tAC0;AS_VQSR\tAC=0;AC_XX=0;AC_XY=0;"));
  ...
  public void canReadTabixVCFFromLocal()
    ...
    assertEquals(3, tif.getFeatureList().size());
    assertEquals(
        "1	1105468	.	G	A	.	PASS	AA=g;AC=2;AN=174;DP=1238", tif.getFeatureList().get(0).getRaw());
  }
