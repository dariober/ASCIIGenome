...
public class TextReadTest {
  ...
  public void canShowInsertion()
    ...
    TextRead tr = new TextRead(rec, gc, false);
    // 7: code for "invert" colours. Checking for "[7;" is brittle since it assumes 7 is the first
    // code.
  ...
  @Test
  public void canShadeBaseQuality()
      throws InvalidGenomicCoordsException, IOException, InvalidColourException {
    GenomicCoords gc = new GenomicCoords("chr7:1-80", 80, null, null);
    SAMRecord rec = new SAMRecord(null);
    rec.setAlignmentStart(1);
  ...
  @Test
  public void canShadeBaseQualityWithSoftClip()
      throws InvalidGenomicCoordsException, IOException, InvalidColourException {
  ...
  public void canPrintDNARead()
    ...
    assertEquals(
        "AACCGGTTAACCGGTTAAC".length(), textRead.getTextEnd() - textRead.getTextStart() + 1);
  ...
  @Test
  public void canPrintFormattedRead()
      throws InvalidGenomicCoordsException, IOException, InvalidColourException {
  ...
  @Test
  public void canPrintSquashedRead()
      throws InvalidGenomicCoordsException, IOException, InvalidColourException {
  ...
  @Test
  public void canPrintReadWithSkippedBases()
      throws InvalidGenomicCoordsException, IOException, InvalidColourException {
