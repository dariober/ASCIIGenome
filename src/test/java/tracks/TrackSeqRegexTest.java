...
public class TrackSeqRegexTest {
  ...
  @Test
  public void canReturnTrackFromMatchingRegex()
      throws InvalidGenomicCoordsException,
          IOException,
          ClassNotFoundException,
          InvalidRecordException,
  ...
  public void canIntrepretIupac()
    ...
    assertTrue(
        trackSeqRegex.getFeatureList().size() > 5
            && trackSeqRegex.getFeatureList().size() < 100);

    assertTrue(trackSeqRegex.printToScreen().contains("ATC"));
  }

  @Test
  public void handlingMissingFastaFile()
  ...
  @Test
  public void canSaveMatchesToFile()
      throws InvalidGenomicCoordsException,
          IOException,
          ClassNotFoundException,
          InvalidRecordException,
