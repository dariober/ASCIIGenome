...
public class TravisExcludedTest {
  ...
  @Test
  public void canGetListOfOpenedFiles()
    ...
    trackSet.addTrackFromSource(
        "ftp://ftp.ensembl.org/pub/release-86/gff3/homo_sapiens/Homo_sapiens.GRCh38.86.chromosome.18.gff3.gz",
        gc,
        null);
  ...
  @Test
  public void canConstructTrackSetFromURL()
    ...
    TrackSet trackSet = new TrackSet(new ArrayList<String>(), gc);
    trackSet.addTrackFromSource(
        "http://hgdownload.cse.ucsc.edu/goldenpath/hg19/encodeDCC/wgEncodeCaltechRnaSeq/wgEncodeCaltechRnaSeqGm12878R2x75Il400GeneGencV3cRep2V3.gtf.gz",
        gc,
        null);
    trackSet.addTrackFromSource(
        "ftp://ftp.ensembl.org/pub/release-86/gff3/homo_sapiens/Homo_sapiens.GRCh38.86.chromosome.18.gff3.gz",
