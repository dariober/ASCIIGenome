...
public class TrackTest {
  ...
  @Test
  public void canConcatTitleAndTrack()
      throws ClassNotFoundException,
          IOException,
          InvalidGenomicCoordsException,
          InvalidRecordException,
  ...
  @Test
  public void canConcatTitleAndTrackWithNoFeatures()
      throws ClassNotFoundException,
          IOException,
          InvalidGenomicCoordsException,
          InvalidRecordException,
  ...
  @Test
  public void canParsePrintableLinesWithSystemCommand()
      throws ClassNotFoundException,
          IOException,
          InvalidGenomicCoordsException,
          InvalidRecordException,
  ...
  @Test
  public void canParsePrintableLinesWithInvalidCommand()
      throws ClassNotFoundException,
          IOException,
          InvalidGenomicCoordsException,
          InvalidRecordException,
  ...
  @Test
  public void canHighlightLinesByIndex()
      throws ClassNotFoundException,
          IOException,
          InvalidGenomicCoordsException,
          InvalidRecordException,
  ...
  @Test
  public void canHighlightPrintableLines()
      throws ClassNotFoundException,
          IOException,
          InvalidGenomicCoordsException,
          InvalidRecordException,
    ...
    List<String> xlist =
        Splitter.on("\t").omitEmptyStrings().splitToList(out.replaceAll(" \\| |\n", "\t"));
    assertEquals(24, xlist.size());
  }

  @Test
  public void canHighlightFormatInVcfLines()
      throws ClassNotFoundException,
          IOException,
          InvalidGenomicCoordsException,
          InvalidRecordException,
  ...
  //	@Test
  //	public void canParsePrintableLinesWithSystemCommandBcftools() throws ClassNotFoundException,
  // IOException, InvalidGenomicCoordsException, InvalidRecordException, SQLException,
  // InvalidColourException, InvalidCommandLineException{
  //
  //		GenomicCoords gc= new GenomicCoords("1:1-400000", 80, null, null);
  //		TrackIntervalFeature tif= new
  // TrackIntervalFeature("test_data/ALL.wgs.mergedSV.v8.20130502.svs.genotypes.vcf", gc);
  //		tif.setNoFormat(true);
  //		tif.setPrintMode(PrintRawLine.FULL);
  //		// Use full path to bcftools only for testing because Eclipse doesn't look into user's PATH
  //		tif.setSystemCommandForPrint("/usr/local/bin/bcftools query -f
  // '%CHROM\t%POS\t%AF\t[%GT:]\n'");
  ...
  @Test
  public void canParsePrintableLinesWithNoFeatures()
      throws ClassNotFoundException,
          IOException,
          InvalidGenomicCoordsException,
          InvalidRecordException,
  ...
  @Test
  public void canPrintLinesWithLineFeedInAttribute()
      throws ClassNotFoundException,
          IOException,
          InvalidGenomicCoordsException,
          InvalidRecordException,
    ...
    assertTrue(
        tif.printLines()
            .contains(
                "InterPro %0Daccession:IPR000980 %0Adescription:SH2 \\ndomain %0Amethod:InterPro"));
  }

  @Test
  public void canParsePrintBAM()
  ...
  @Test
  public void canPrintBamWithClippedSeq()
      throws InvalidGenomicCoordsException,
          IOException,
          InvalidColourException,
          InvalidCommandLineException,
  ...
  @Test
  public void canPrintVcfWithClippedSeq()
      throws InvalidGenomicCoordsException,
          IOException,
          InvalidColourException,
          InvalidCommandLineException,
  ...
  @Test
  public void printIsNotResetAfterExec()
      throws InvalidGenomicCoordsException,
          IOException,
          InvalidColourException,
          InvalidCommandLineException,
